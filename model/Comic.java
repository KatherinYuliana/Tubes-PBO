...
public class Comic extends Book {
    ...
    // public Comic(int book_id, String title, String author, int publication_year, GenreEnum genre, CategoryBookEnum category,
    //         double rating, String sinopsis, BookStatusEnum book_status, Blob book_cover, String ilustrator, CategoryComicEnum category_comic) {
    ...
    // public Comic(String ilustrator, CategoryComicEnum category_comic) {
    //     this.ilustrator = ilustrator;
    //     this.category_comic = category_comic;
    // }
    ...
    // public Comic(int book_id, String title, String author, int year, String genre, String category, double rating,
    //         String synopsis, String status, String coverPath, int j, String ilustrator,
    //         CategoryComicEnum category_comic) {
    //     super(book_id, title, author, year, genre, category, rating, synopsis, status, coverPath, j);
    //     this.ilustrator = ilustrator;
    //     this.category_comic = category_comic;
    // }
